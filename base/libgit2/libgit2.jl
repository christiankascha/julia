...
Equivalent to `git fetch [<url>|<repository>] [<refspecs>]`.
Fetches updates from the `remote` upstream of `repo`, looking at `remoteurl`.
...
Equivalent to `git push [<url>|<repository>] [<refspecs>]`.
...
Equivalent to `git checkout [-b|-B] <branch> [<start-point>] [--track <remote>/<branch>]`.
